...
/**
 *
 * This file contains an implementation of the optimized self join loop with two
 * predicates using bitmap array to optimize the bitmap scan operation
 */

public class SelfInequalityJoinTwoPredicateOptimized extends Iterator {
	 ...
	 */
	public SelfInequalityJoinTwoPredicateOptimized(AttrType in1[], int len_in1, short t1_str_sizes[], AttrType in2[],
			int len_in2, short t2_str_sizes[], int amt_of_mem, Iterator am1, String relationName, CondExpr outFilter[],
			CondExpr rightFilter[], FldSpec proj_list[], int n_out_flds, int size_of_chuncks, String file_path)
		...
		this.reader = new BufferedReader(new FileReader("../../../../Output/" + file_path + ".txt"));
	...
	public Tuple get_next() throws IOException, JoinsException, IndexException, InvalidTupleSizeException,
		...
		while (outer_index < number_of_rows) {
			...
			while (inner_index < number_of_rows) {
				...
				bitmap_index = (int) (inner_index / chunks);
