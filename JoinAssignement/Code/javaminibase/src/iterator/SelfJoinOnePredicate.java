...
/**
 *
 * This file contains an implementation of the self join loop with one
 * predicate.
 */
...
public class SelfJoinOnePredicate extends Iterator {
	 ...
	 */
	public SelfJoinOnePredicate(AttrType in1[], int len_in1, short t1_str_sizes[], AttrType in2[], int len_in2,
		...
		try {
			...
			throw new NestedLoopException(e, "TupleUtilsException is caught by SelfJoinOnrPredicate.java");
		}
