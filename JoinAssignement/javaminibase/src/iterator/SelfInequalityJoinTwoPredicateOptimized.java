...
/** 
*
*  This file contains an implementation of the optimized self join loop with two predicates using bitmap 
*  array to optimize the bitmap scan operation
*/
...
public class SelfInequalityJoinTwoPredicateOptimized  extends Iterator 
{
   ...
   */
  public SelfInequalityJoinTwoPredicateOptimized( AttrType    in1[],    
			   int     len_in1,           
			   short   t1_str_sizes[],
			   AttrType    in2[],         
			   int     len_in2,           
