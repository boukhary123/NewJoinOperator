...
public class InequalityJoinTwoPredicates extends Iterator {
	 ...
	 */
	public InequalityJoinTwoPredicates(AttrType in1[], int len_in1, short t1_str_sizes[], AttrType in2[], int len_in2,
			short t2_str_sizes[], int amt_of_mem, Iterator am1, String relationName1, String relationName2,
			CondExpr outFilter[], CondExpr rightFilter[], FldSpec proj_list[], int n_out_flds, String file_path1,
			String file_path2) throws IOException, NestedLoopException {
		...
		try {
			...
			// sort all arrays according to the specified sort order
			if (Descending_op1) {
