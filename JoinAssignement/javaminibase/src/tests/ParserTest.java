...
public class ParserTest  implements GlobalConst {
	...
	public static ArrayList<Row_to_compare> L_selfjoin_two_optimized;
...
//				  						    }
	  ...
	  public static void main(String argv[])
	  {
	      ...
	      System.out.println("Self join 2 predicates takes " + 
                  (end - start) + "ms"); 
	      start = System.currentTimeMillis();
		  ParserTest5();
		  end = System.currentTimeMillis(); 
		  System.out.println("Optimized IESelfJoin takes " + 
                  (end - start) + "ms");	
		  
		  compare_2_arrays(L_nlj,L_selfjoin_two_optimized);
		  }
}
