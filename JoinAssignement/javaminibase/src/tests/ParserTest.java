...
public class ParserTest  implements GlobalConst {
	...
	public static ArrayList<Row_to_compare> L_nlj,L_ieqjoin,
	L_selfjoin_one,L_selfjoin_two,L_selfjoin_two_optimized,L_ieqjoin_optimized;
...
//				  						    }
	  ...
	  public static void main(String argv[])
	  {
		  ...
		  ParserTest test = new ParserTest("../../query_2c_1.txt");
		  //ParserTest4();
	      long end = System.currentTimeMillis(); 
		  
	      System.out.println("IE join 2 predicates takes " + 
                  (end - start) + "ms"); 
	      start = System.currentTimeMillis();
		  ParserTest6();
		  end = System.currentTimeMillis(); 
		  System.out.println("Optimized IEJoin takes " + 
                  (end - start) + "ms");	
		  
		  compare_2_arrays(L_nlj,L_ieqjoin_optimized);
		  }
}
